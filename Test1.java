import Lib.*;
import Lib.Discount.Bogo;
import Lib.Discount.Bulk;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        pricingService.addStrategy("P001", new Bogo());
        pricingService.addStrategy("P002", new Bulk(6, 0.10));

        // --- Test Cases ---
        
        System.out.println("\n--- Testing ShoppingCart ---");
        ShopingCartitem cart = new ShopingCartitem(pricingService, catalog);
        ...
        pricingService.addStrategy("P001", new Bulk(3, 0.50)); // เปลี่ยนโปรโมชัน Apple เป็นซื้อ 3 ลด 50%
        ...
        check("Find existing product", catalog.findByld("P001").equals(apple));
        check("Find non-existent product returns null", catalog.findByld("P999") == null);
